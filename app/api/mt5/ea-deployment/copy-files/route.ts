...
import { copyEaFiles, enginePolicyFromEnv, assertPolicy } from '@/services/ea-deployment/ea-deployment-engine';
...
export async function POST(request: Request): Promise<Response> {
  try {
    ...
    const result = await copyEaFiles(policy, payload.config, Boolean(payload.force));
