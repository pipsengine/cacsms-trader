/**
 * One-off import: CHF rate history from Investing.com event page 169.
 * Usage: node scripts/import-chf-rate-history.mjs
 */
...
Jun 18, 2026 (Q2) 08:30 — 0.00% 0.00%
Mar 19, 2026 (Q1) 09:30 0.00% 0.00% 0.00%
Dec 11, 2025 (Q4) 09:30 0.00% 0.00% 0.00%
Sep 25, 2025 (Q3) 08:30 0.00% 0.00% 0.00%
Jun 19, 2025 (Q2) 08:30 0.00% 0.00% 0.25%
Mar 20, 2025 (Q1) 09:30 0.25% 0.25% 0.50%
Dec 12, 2024 (Q4) 09:30 0.50% 0.75% 1.00%
Sep 26, 2024 (Q3) 08:30 1.00% 1.00% 1.25%
Jun 20, 2024 (Q2) 08:30 1.25% 1.50% 1.50%
Mar 21, 2024 (Q1) 09:30 1.50% 1.75% 1.75%
Dec 14, 2023 (Q4) 09:30 1.75% 1.75% 1.75%
Sep 21, 2023 (Q3) 08:30 1.75% 2.00% 1.75%
Jun 22, 2023 (Q2) 08:30 1.75% 1.75% 1.50%
Mar 23, 2023 (Q1) 09:30 1.50% 1.50% 1.00%
Dec 15, 2022 (Q4) 09:30 1.00% 1.00% 0.50%
Sep 22, 2022 (Q3) 08:30 0.50% 0.50% -0.25%
Jun 16, 2022 (Q2) 08:30 -0.25% -0.75% -0.75%
Mar 24, 2022 (Q1) 09:30 -0.75% -0.75% -0.75%
Dec 16, 2021 (Q4) 09:30 -0.75% -0.75% -0.75%
Sep 23, 2021 (Q3) 08:30 -0.75% -0.75% -0.75%
Jun 17, 2021 08:30 -0.75% — -0.75%
Mar 25, 2021 09:30 -0.75% — -0.75%
Dec 17, 2020 09:30 -0.75% -0.75% -0.75%
Sep 24, 2020 08:30 -0.75% -0.75% -0.75%
Jun 18, 2020 08:30 -0.75% -0.75% -0.75%
Mar 19, 2020 09:30 -0.75% -0.75% -0.75%
Dec 12, 2019 09:30 -0.75% -0.75% -0.75%
Sep 19, 2019 08:30 -0.75% -0.75% -0.75%
Jun 13, 2019 08:30 -0.75% -0.75% -0.75%
Mar 21, 2019 09:30 -0.75% -0.75% -0.75%
Dec 13, 2018 09:30 -0.75% -0.75% -0.75%
Sep 20, 2018 08:30 -0.75% -0.75% -0.75%
Jun 21, 2018 08:30 -0.75% -0.75% -0.75%
Mar 15, 2018 09:30 -0.75% -0.75% -0.75%
Dec 14, 2017 09:30 -0.75% -0.75% -0.75%
Sep 14, 2017 08:30 -0.75% -0.75% -0.75%
Jun 15, 2017 08:30 -0.75% -0.75% -0.75%
Mar 16, 2017 09:30 -0.75% -0.75% -0.75%
Dec 15, 2016 09:30 -0.75% -0.75% -0.75%
Sep 15, 2016 08:30 -0.75% -0.75% -0.75%
`;
...
const EVENT_ID = 169;
const CURRENCY = 'CHF';
const CENTRAL_BANK = 'Swiss National Bank (SNB)';
const COUNTRY = 'Switzerland';
const EVENT_NAME = 'Interest Rate Decision';
const SOURCE_URL = 'https://www.investing.com/economic-calendar/interest-rate-decision-169';
...
console.log(`Parsed ${rows.length} CHF rows`);
...
await pool.query(
  `INSERT INTO rate_sync_logs (event_id, currency, sync_started_at, sync_completed_at, status, rows_fetched, rows_inserted, rows_updated, error_message)
   VALUES ($1,$2, now(), now(), 'PASTE_IMPORT_CHF', $3,$4,$5, null)`,
  [EVENT_ID, CURRENCY, rows.length, inserted, updated],
);

const count = await pool.query(`SELECT COUNT(*)::int AS count FROM central_bank_rate_history WHERE currency = 'CHF'`);
console.log(JSON.stringify({ ok: true, parsed: rows.length, inserted, updated, chfTotal: count.rows[0]?.count }, null, 2));
